...
class FloorObjectGenerator:
    ...
    def generate_objects(self, scene, use_constraint=True):
        ...
        for placements, room_constraints in all_placements:
            results += placements
            scene_graph.update(room_constraints)

        return results, scene_graph
    ...
    def generate_objects_per_room(self, args):
        ...
        return placements, {room_id: constraints}
